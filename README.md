...
<h5>7- Test de la méthode POST en incluant l'en-tête avec la clé Content-Type définie sur l'application/json, en ajoutant diverses données comme : (Balance, Type et Currency). Ensuite, création du compte générée avec l'ID, alors que le champ createdAt, dont la valeur n'est pas envoyée reste null.</h5>
